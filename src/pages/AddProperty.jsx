  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://real-state-homenest.vercel.app/properties",
        {
          method: "POST",
          headers: {
        ...
        <form
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              required
              className="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:outline-none"></textarea>
          </div>
